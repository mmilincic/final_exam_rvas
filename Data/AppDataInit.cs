            ...
            if (!context.Vozaci.Any())
            {
                ...
                if (!context.Trke.Any())
                {
                    context.Trke.AddRange(
                        new Trke { staza = 1, datumTrke = new DateOnly(2025, 05, 14) },
                        new Trke { staza = 2, datumTrke = new DateOnly(2025, 06, 23) },
                        new Trke { staza = 3, datumTrke = new DateOnly(2025, 07, 18) },
                        new Trke { staza = 4, datumTrke = new DateOnly(2025, 03, 28) },
                        new Trke { staza = 5, datumTrke = new DateOnly(2025, 02, 26) }
                    );
                    context.SaveChanges();
                }
